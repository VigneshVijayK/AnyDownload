...
const steps = [
  {
    ...
    desc: "Select Instagram, YouTube, X/Twitter, Facebook, or Threads",
  },
  {
    number: "02",
    icon: (
        ...
        {steps.map((step, i) => (
          <Fragment key={i}>
            ...
            >
              ...
              <div
                className="w-[48px] h-[48px] sm:w-[60px] sm:h-[60px] mx-auto mb-3 sm:mb-[18px] rounded-[12px] sm:rounded-[16px] flex items-center justify-center text-white text-lg sm:text-[22px] transition-all duration-500"
                style={{
